...
// into the binary. Go's //go:embed directive requires paths relative
...
// detail), the embed directives must live here too. internal/blueprint
// imports this package to access the embedded content.
